...
export function Navbar({ onOpenNotifications, onOpenBadges }: NavbarProps) {
  ...
  return (
    <header className="sticky top-0 z-50 px-2.5 sm:px-6 py-2.5 sm:py-3 safe-area-top transition-all bg-reader-glass backdrop-blur-2xl border-b border-reader-border w-full max-w-full">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-1.5 sm:gap-4">
        {/* Brand Logo & Group Selector */}
        <div className="flex items-center gap-1.5 sm:gap-4 shrink-0 min-w-0">
          <NavLink to="/dashboard" className="flex items-center gap-1.5 sm:gap-2 group shrink-0">
            <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-reader-surface border border-reader-borderStrong flex items-center justify-center text-reader-accent shadow-sm">
